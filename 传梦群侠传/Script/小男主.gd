		...
		if Input.is_action_pressed("leftClick")  and !Global.onTalk and !Global.onButton and !onArrowButton :
			...
			if canMove:
				...
				if -90 <= angle_in_degrees and angle_in_degrees <= 0:
					...
					frames =  [
							preload("res://main character/image8.png"),
							preload("res://main character/image9.png"),
							preload("res://main character/image10.png"),
							preload("res://main character/image11.png"),
						  ]	
					directions = "up"
				if -180 <= angle_in_degrees and angle_in_degrees <= -90:
					...
					$AnimatedSprite2D.visible = true
					frames =  [
								preload("res://main character/image12.png"),
								preload("res://main character/image13.png"),
								preload("res://main character/image14.png"),
								preload("res://main character/image15.png"),
							  ]	
				...
				if 90 <= angle_in_degrees and angle_in_degrees <= 180:	
					...
					$AnimatedSprite2D.visible = true
					frames =  [
							preload("res://main character/image4.png"),
							preload("res://main character/image5.png"),
							preload("res://main character/image6.png"),
							preload("res://main character/image7.png"),
						  ]	
					#update_animation(deltas)
				...
				if 0 <= angle_in_degrees and angle_in_degrees <= 90:	
					...
					$AnimatedSprite2D.visible = true	
					frames =  [
							preload("res://main character/image0.png"),
							preload("res://main character/image1.png"),
							preload("res://main character/image2.png"),
							preload("res://main character/image3.png"),
						  ]
