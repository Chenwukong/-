		...
		if Input.is_action_pressed("leftClick")  and !Global.onTalk and !Global.onButton and !onArrowButton :
			...
			if canMove:
				...
				if -90 <= angle_in_degrees and angle_in_degrees <= 0:
					...
					frames =  [
							preload("res://main character/yanzi008.png"),
							preload("res://main character/yanzi009.png"),
							preload("res://main character/yanzi010.png"),
							preload("res://main character/yanzi011.png"),
						  ]	
					directions = "up"
				if -180 <= angle_in_degrees and angle_in_degrees <= -90:
					...
					$AnimatedSprite2D.visible = true
					frames =  [
								preload("res://main character/yanzi012.png"),
								preload("res://main character/yanzi013.png"),
								preload("res://main character/yanzi014.png"),
								preload("res://main character/yanzi015.png"),
							  ]	
				...
				if 90 <= angle_in_degrees and angle_in_degrees <= 180:	
					...
					$AnimatedSprite2D.visible = true
					frames =  [
							preload("res://main character/yanzi004.png"),
							preload("res://main character/yanzi005.png"),
							preload("res://main character/yanzi006.png"),
							preload("res://main character/yanzi007.png"),
						  ]	
					#update_animation(deltas)
				...
				if 0 <= angle_in_degrees and angle_in_degrees <= 90:	
					...
					$AnimatedSprite2D.visible = true	
					frames =  [
							preload("res://main character/yanzi000.png"),
							preload("res://main character/yanzi001.png"),
							preload("res://main character/yanzi002.png"),
							preload("res://main character/yanzi003.png"),
						  ]
